    ...
    return (
      <div className="flex min-h-svh w-full flex-col bg-[#100d1e] pt-16">
        ...
        <main className="mx-auto box-border w-full max-w-[1280px] px-6 pt-12 pb-16">
          <h1 className="mb-10 text-[32px] font-bold tracking-[-0.5px] text-[#eeeaff]">Wishlist</h1>
          <div className="flex flex-col items-center justify-center gap-3 px-6 py-20 text-center">
            ...
            <p className="m-0 text-[20px] font-semibold text-[#eeeaff]">Your wishlist is empty</p>
          ...
          {wishlistItems.map((item) => (
            ...
            >
              ...
              <div className="flex flex-1 flex-col gap-1 px-4 pt-3.5 pb-2">
                <span className="text-[15px] font-medium text-[#eeeaff]">{item.name}</span>
              ...
              <div className="flex items-center gap-2.5 px-4 pt-3 pb-4">
                <button
                  className="flex flex-1 cursor-pointer items-center justify-center gap-1.5 rounded-lg border-none bg-purple-400 px-3.5 py-2.5 text-[13px] font-semibold tracking-[0.3px] text-[#100d1e] transition-opacity hover:opacity-88"
                  onClick={() => onAddToCart(item)}
                >
                  <CartIcon /> Add to Cart
                </button>
                <button
                  className="flex cursor-pointer items-center rounded-lg border border-white/15 bg-transparent p-2.5 text-[rgba(190,178,215,0.82)] transition-colors hover:border-[rgba(232,93,93,0.3)] hover:bg-[rgba(232,93,93,0.1)] hover:text-[#e85d5d]"
